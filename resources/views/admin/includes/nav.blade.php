<nav>
    ...
    <ul class="nav-ul">
        <a href="/admin/dashboard"><li id="dash-link">
            <i class="fas fa-tachometer-fast fa-fw"></i>
            <b>Dashboard</b>
        </li></a>

        <a href="/admin/settings"><li id="settings-link">
        ...
        <a href="#"><li id="equip-link">
            <i class="fas fa-swords fa-fw"></i>
            <b>Equipment</b>
        </li></a>

        <a href="#"><li id="towns-link">
            <i class="fas fa-city fa-fw"></i>
            <b>Towns</b>
        </li></a>

        <a href="#"><li id="mobs-link">
            <i class="fas fa-paw-claws fa-fw"></i>
            <b>Creatures</b>
        </li></a>

        <a href="#"><li class='tickets-link'>
